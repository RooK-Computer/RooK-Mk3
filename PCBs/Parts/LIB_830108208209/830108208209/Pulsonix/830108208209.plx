...
//19867742/1571036/2.50/4/4/Crystal or Oscillator
...
(library Library_1
	...
	(patternDef "830108208209" (originalName "830108208209")
		(multiLayer
	...
	(symbolDef "830108208209" (originalName "830108208209")
	...
	(compDef "830108208209" (originalName "830108208209") (compHeader (numPins 4) (numParts 1) (refDesPrefix Y)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "830108208209"))
		(attachedPattern (patternNum 1) (patternName "830108208209")
			(numPads 4)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "830108208209")
		(attr "Mouser Part Number" "710-830108208209")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Wurth-Elektronik/830108208209?qs=hWgE7mdIu5Qfk68EXTEoAw%3D%3D")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "24 MHz +/-10ppm Crystal 10pF 100 Ohms 4-SMD, No Lead")
		(attr "<Hyperlink>" "https://www.we-online.com/components/products/datasheet/830108208209.pdf")
		(attr "<Component Height>" "0.6")
		(attr "<STEP Filename>" "830108208209.stp")
