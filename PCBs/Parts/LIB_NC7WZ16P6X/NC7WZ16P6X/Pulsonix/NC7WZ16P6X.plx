...
(library Library_1
	...
	(compDef "NC7WZ16P6X" (originalName "NC7WZ16P6X") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "A1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Input))
		...
		(compPin "6" (pinName "Y1") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Output))
		(compPin "5" (pinName "VCC") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "4" (pinName "Y2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Output))
		...
		(attr "<Hyperlink>" "https://www.onsemi.com/pub/Collateral/NC7WZ16-D.PDF")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "NC7WZ16P6X.stp")
